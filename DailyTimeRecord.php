<?php
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $get_user = mysqli_query($connection,"SELECT * FROM employees WHERE id='$id'");
...
<head>
    ...
    <link rel="stylesheet" href="css/DailyTimeRecord.css">
...
<body>
    ...
    <section class="sidebar">
              <div class="logo-sidebar">ADMIN</div>
                <ul>
                    ...
                    <li><a href="DailyTimeRecord.php" class="btn-active"><i class="fas fa-calendar"></i>Reports</a></li>
    ...
    <main class="main">  
        <div class="card-body">
            <div class="logo-main">employee's dtr</div>

            <div class="container" id="print-container">
                <h2>--Employee`s Record--<br> (<?= date('F, Y') ?>) </h2>
        ...
        while($row_data = mysqli_fetch_array($get_data)){
            ...
            if($count == $date){ 
                ...
                <tr>     
                    ...
                    <td><?php if($row_data['overall_total_hours']=="0"){echo '';}else{ echo $row_data['morning_total_hours']+$row_data['afternoon_total_hours'].'&nbsp;Hours';} ?></td>
                ...
                <?php
                // No need to calculate totals here
...
?>
    ...
    <script>
        function filter_employee(){
            ...
            window.location.href="DailyTimeRecord.php?id="+employee_id
        }
    </script>
